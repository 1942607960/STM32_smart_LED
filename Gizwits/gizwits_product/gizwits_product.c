...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
    ...
    for(i=0; i<info->num; i++)
    {
        ...
        case EVENT_coldled:
            currentDataPoint.valuecoldled = dataPointPtr->valuecoldled;
            GIZWITS_LOG("Evt:EVENT_coldled %d\n",currentDataPoint.valuecoldled);
            //user handle
			PWM_SetCompare1(currentDataPoint.valuecoldled);
            ...
            break;
        case EVENT_warmled:
            currentDataPoint.valuewarmled = dataPointPtr->valuewarmled;
            GIZWITS_LOG("Evt:EVENT_warmled %d\n",currentDataPoint.valuewarmled);
            //user handle
			PWM_SetCompare2(currentDataPoint.valuewarmled);
...
void userInit(void)
{
    ...
    currentDataPoint.valuecoldled = 0;
    currentDataPoint.valuewarmled = 0;
