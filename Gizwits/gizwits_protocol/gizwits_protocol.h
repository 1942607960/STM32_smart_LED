...
* @{
*/
#define PRODUCT_KEY "73c6521a469f421990167c014595d6e7"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "20e19b1bd9e54e76ad9ad06af1ae8822"
...
#define humi_MAX                           100
#define humi_LEN                           1
#define coldled_RATIO                         1
#define coldled_ADDITION                      0
#define coldled_MIN                           0
#define coldled_MAX                           100
#define coldled_LEN                           1
#define warmled_RATIO                         1
#define warmled_ADDITION                      0
#define warmled_MIN                           0
#define warmled_MAX                           100
#define warmled_LEN                           1
...
typedef struct {
    uint32_t valuetemp;
    uint32_t valuehumi;
    uint32_t valuecoldled;
    uint32_t valuewarmled;
} dataPoint_t;
...
typedef struct {
    uint8_t flagtemp:1;
    uint8_t flaghumi:1;
    uint8_t flagcoldled:1;
    uint8_t flagwarmled:1;
} dataPointFlags_t;
...
typedef struct {
    uint8_t valuetemp;
    uint8_t valuehumi;
    uint8_t valuecoldled;
    uint8_t valuewarmled;
} devStatus_t;
